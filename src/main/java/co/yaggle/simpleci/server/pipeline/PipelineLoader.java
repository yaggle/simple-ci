...
import co.yaggle.simpleci.server.exception.MissingPipelineException;
import co.yaggle.simpleci.server.pipeline.parser.PipelineElement;
import co.yaggle.simpleci.server.pipeline.parser.TaskElement;
...
import static co.yaggle.simpleci.server.pipeline.parser.PipelineParser.*;
